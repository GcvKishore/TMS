...
function generateFormat() {
    ...
    let html_button = ""
    if (selection === 0) {
        html_button = '<div class="row" id="options_area"></div><button class="btn btn-primary" type="button" id="generateBtn" onclick="addOption()"> Add Options</button><hr>'
    } else if (selection === 1) {
        // html_button = '<div id="answers_area"></div><button onclick="addAnswer()" type="button"> Add Answers</button>'
        html_button = '<div class="row" id="answers_area"></div><button onclick="addAnswer()" class="btn btn-primary" type="button" id="generateBtn"> Add Answers</button><hr>'
    }
    count = 0
